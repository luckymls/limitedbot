...
if($chatID == $admin or $user[id] == $admin) $isadmin = true;
...
if($isadmin) $text = "Welcome! This is your bot! To reply: reply to forwarded message";
sm($chatID, $text);
break;
}
...
$type = "Staff";
if($chatID > 0) $type = "Admin";


$a = sm($id, "<b>$type:</b> \n".ucfirst($msg));

if(!$a) sm($chatID, "$id disabled the bot"); mysql_query("DELETE FROM $tab WHERE chat_id = $id");

}elseif(!$id and $msg and $chatID > 0){sm($chatID, "To reply, reply to a forwarded message");}
